...
# Sample descriptors from descriptor map at keypoints
...
# Define the differentiable keypoint detection model from ALIKED paper
class DKD(pl.LightningModule):
    def __init__(self, radius: int=2, top_k: int=0, scores_th: float=0.2, n_limit:int=20000, script: bool=False, temp_det: float=0.1):
        """
        Args:
    ...
    def forward(self, scores_map:Tensor, descriptor_map:Tensor, normalized_coordinates=True):
        """
